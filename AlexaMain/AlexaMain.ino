...
#define MySSID "YULABoys-Guest" // TODO: Change to your Wifi network SSID
#define MyWifiPassword "yula9760" // TODO: Change to your Wifi network password
...
void turnOn(String deviceId) {
  ...
  else if (deviceId == "5bbfe84d4faa305661930c93") // Device ID of second device
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
